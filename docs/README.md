...
| FR.012 | Система должна сохранять видео/аудио выступлений в режиме стрима, конвертируя поток в кодек helloconf267 (tm) |
...
| QR.006 | Система поддерживать ежегодный рост на 15% количества участников конференции онлайн | Требование QR.002 должно выполняется при числе участников до 1150 человек в течение следующего года после релиза системы, и 1322 ещё через год |
