...
| Трансляция | Стрим | Аудио- или видео- медиапоток онлайн выступления участников (докладчиков) выступления |
| Комментарий |  | Сообщение, которое может оставить любой участник конференции к выступлению |
| Чат |  | Набор комментариев к отдельному выступлению |
