...
необходимо проводить онлайн-конференции.

Требуется инструмент организации и проведения конференций в режиме онлайн, где обеспечить поддержку большого числа участников. Стартовым проектом является проведение конференции helloconf.
